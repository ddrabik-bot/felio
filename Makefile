...
.PHONY: up down restart logs build ps test test-fx test-market-data-persistence frontend migrate smoke-migrations spike-yfinance spike-nbp-fx test-nbp-fx-spike
